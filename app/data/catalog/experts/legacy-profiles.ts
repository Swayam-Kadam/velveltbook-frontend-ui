import type { LegacyExpertProfile } from "@/types/legacy-expert";
...
export const experts: Record<string, LegacyExpertProfile> = {
  e1: {
    id: "e1",
    name: "Georgina Kate",
...
export function getExpert(id: string): LegacyExpertProfile {
