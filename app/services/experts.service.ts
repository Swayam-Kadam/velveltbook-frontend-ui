import categoriesData from "@/data/catalog/experts/categories.json";
import expertsData from "@/data/catalog/experts/experts.json";
import filtersData from "@/data/catalog/experts/filters.json";
import mobileData from "@/data/catalog/experts/mobile.json";
import profilesData from "@/data/catalog/experts/profiles.json";
...
function getAvailabilityHours(expertId: string): string {
  ...
  const startHour = 6 + (hash % 6);
  const endHour = 17 + ((hash >> 3) % 6);
