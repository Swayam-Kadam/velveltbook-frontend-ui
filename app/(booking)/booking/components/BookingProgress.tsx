...
export function BookingProgress({
  ...
  return (
    <div className="relative mt-4 lg:mt-6 lg:px-8">
      <div className="lg:hidden">
        <ProgressTrack steps={serviceSteps} currentStep={currentStep} />
      </div>
      <div className="hidden lg:block">
        <ProgressTrack
          steps={serviceStepsDesktop}
          currentStep={serviceDesktopStep}
        />
      </div>
    </div>
  );
