...
/** Change this value to resize the modal (e.g. "32rem", "40rem", "85dvh"). */
export const EXPERT_PROFILE_MODAL_HEIGHT = "45rem";
    ...
    >
      <div
        className="
          ...
          rounded-2xl bg-(--bg-primary) shadow-(--shadow-glow) mt-[20%]
        "
        style={{
          height,
