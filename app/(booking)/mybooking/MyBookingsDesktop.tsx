  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 8c4 8 12 10 12 18s-8 12-12 18c-4-6-12-10-12-18s8-10 12-18z' fill='%233d1c4d' fill-opacity='0.9'/%3E%3C/svg%3E\")",
              ...
              >
                ...
                <div className="flex min-h-0 flex-col gap-3 overflow-y-auto pr-0.5 scrollbar-thin scrollbar-thumb-(--accent-primary)/25">
                  <article className={`${cardShell} p-3.5`}>
                    ...
                    {statusTab === "upcoming" ? <ChangeButton /> : null}
                  </article>
