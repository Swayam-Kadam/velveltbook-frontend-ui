...
export function CategorySlider({
  ...
  return (
    <div className="scrollbar-none flex justify-between gap-2 overflow-x-auto px-1 py-2 lg:grid lg:grid-cols-8 lg:gap-2.5 lg:overflow-visible lg:px-0 lg:py-5">
